...
Static Function PrintReport(oReport)
	...
	TcQuery cQuery New Alias 'QRY' //Cria a tabela temporaria
	
	While QRY->(!Eof()) //Enquanto tiver registros
		
		ZZ4->(DbGoto(QRY->RECNOZZ4)) //Posiciona no movimento 
		...
		While ZZ5->(!Eof()) .AND. cSeek == ZZ5->(ZZ5_FILIAL + ZZ5_CODZZ4) //Enquanto tiver detalhes do movimento
			oSection2:PrintLine()
			ZZ5->(DBSkip())
		EndDo
