...
User Function ADVPLA04()
	...
	oBrowse:AddLegend("ZZ4->ZZ4_STATUS=='E'", "BLUE"	, "Efetivado")
...
User Function ADPLA04b()
	...
	If ZZ4->ZZ4_STATUS == 'A'
		...
		If MsgYesNo('Confirma a efetiva  o?')
			...
			Else
				...
				ApMsgInfo("T tulo inclu do com sucesso!", 'Aten  o')
			Endif

		EndIf

	Else
		MsgAlert('S  efetivar um movimento ABERTO. ')
	EndIf
			...
			If ZZ4->ZZ4_STATUS == 'E'
				...
				If SE2->(DbSeek(xFilial('SE2') + ZZ4->ZZ4_CODIGO))
					...
					Else
						...
						ApMsgInfo("T tulo exclu do com sucesso!", 'Aten  o')
					Endif
